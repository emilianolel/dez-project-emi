...
SRC_SHELL_PATH = '/usr/local/airflow/src/idm_to_bq_pq_raw/shell/'
...
with DAG(
    ...
    end_cluster = BashOperator(
        task_id='stop_cluster',
        bash_command='end_cluster.sh'
    )
    ...
    start >> start_cluster >> download_idm >> csv_to_pq >> from_gcs_to_bq >> end_cluster >> end

...
ARG GCP_PRJECT=dez-workspace-emil
ARG WORKDIR=/airflow
...
RUN gcloud auth activate-service-account ${GCP_SERVICE_ACCOUNT} --key-file=${GOOGLE_APPLICATION_CREDENTIALS} --project=${GCP_PRJECT}
